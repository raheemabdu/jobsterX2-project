          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-3xl md:h-[70vh] h-[80%] md:ml-30 overflow-y-auto relative shadow-lg animate-fadeIn">
            ...
            <div className="sticky bottom-0 bg-white pt-3 pb-2">
              <button
                ...
                className="bg-pink-500 text-white px-6 md:px-20 py-2 rounded-lg hover:bg-pink-600 transition"
              >
                Analyze with AI
              </button>
            </div>
            ...
            {showResults && (
              <div className="mt-4 space-y-5">
                ...
                <div className="bg-white shadow-md mb-4 mt-6 p-4 rounded-lg">
                ...
                <div className="bg-white shadow-md mb-6 mt-6 p-4 rounded-lg">
                  <h4 className="text-lg text-purple-700 mb-2">
